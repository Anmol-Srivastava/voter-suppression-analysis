...
EXAMPLE_DIR_AGE = os.path.join(data_folder, 'samples', 'example_age_folder', '*_age.csv')
#EXAMPLE_DIR_SEX = str(CWD / '../*data*/*samples*/*example_sex_folder*/*')
EXAMPLE_DIR_SEX = os.path.join(data_folder, 'samples', 'example_sex_folder', '*_sex.csv')
